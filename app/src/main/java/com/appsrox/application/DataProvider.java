package com.appsrox.application;
...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.appsrox.application.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.appsrox.application.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("com.appsrox.application.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("com.appsrox.application.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("com.appsrox.application.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("com.appsrox.application.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
